...
const InfoModal = ({visible,onClose} : InfoModalProps) => {
    ...
    const[isVisibel,setisVisibel] = useState( !!visible);
    ...
    return (
      ...
      <div className="relative w-auto mx-auto max-w-3xl rounded-md overflow-hidden">
        <div className={`${isVisibel ? 'scale-100' : 'scale-0'} transform duration-300 relative flex-auto bg-zinc-900 drop-shadow-md`}>
